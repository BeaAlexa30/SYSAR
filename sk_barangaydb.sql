...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2025 at 01:48 PM
...
INSERT INTO `accepted_members` (`id`, `members_id`, `res_id`, `status`) VALUES
(5, 1, 2025001, 1);
...
(1, 'Bea Aexa', 'Delos Santos', 'Bausas', '', 'sa tabi tabi', 2147483647, 0, 'bea@gmail.com', 'female', 21, '', '2003-05-14', '', 'no', 'Filipino', 'Rolando Bausas', 'Noemi Bausas', 'Rolando Bausas', 'Father', 2147483647, 0, 'sa tabi tabi', '68020732bd474.png', 1);
